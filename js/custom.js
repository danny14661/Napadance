...
function initMap() {
    ...
    const locations = [
        {
            name: "Anand Rao Pawar High School",
            address: "Anand Rao Pawar High School, Mumbai",
            lat: 19.235845,
            lng: 72.841301
        },
        {
            name: "Dosti Acres, Wadala (E)",
            address: "Dosti Acres, Near Antop Hill Bus Stop, Wadala (E)",
            lat: 19.015312,
            lng: 72.857244
        }
    ];
